  ...
  const renderPersonalInfo = () => {
    ...
    return (
      <div style={containerStyle}>
        <Card title='회원 정보' style={cardStyle} styles={cardStyles}>
          <Row gutter={48}>
            <Col span={12}>
              <Space direction='vertical' size='large' style={{ width: "100%" }}>
                ...
                <div style={formItemStyle}>
                  <Space>
                    ...
                    <Input
                      disabled
                      value={memberData.gender == "MALE" ? "남" : "여"}
                      style={inputStyle}
                    />
                  </Space>
                </div>
  ...
  const renderAddresses = () => {
    ...
    return (
      <List
        ...
        renderItem={item => (
          <List.Item
            className={item.isDefaultAddress === "ACTIVE" ? "list-item default" : "list-item"}>
            <List.Item.Meta
              avatar={<HomeOutlined />}
              title={
                <Flex gap='middle'>
              ...
              description={
                <div>
                  {item.generalAddress} {item.detailAddress}
                </div>
              }
            />
          </List.Item>
  ...
  const renderPaymentCards = () => {
    ...
    return (
      <List
        ...
        renderItem={item => (
          <List.Item
            className={item.isDefaultPaymentCard === "ACTIVE" ? "list-item default" : "list-item"}>
            <List.Item.Meta
              ...
              description={<div>카드번호: {item.cardNumber.replace(/\d{4}(?=.)/g, "****")}</div>}
            />
          </List.Item>
        )}
      />
