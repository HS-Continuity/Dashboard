import {
  registerNormalProduct,
  getAllCategories,
  getCategoryDetails,
  registerEcoFriendlyProduct,
  ...
  const onHandleSubmit = async () => {
    ...
    try {
      ...
      if (selectedFoodType === "일반식품") {
        ...
        response = await registerEcoFriendlyProduct(
          product,
          defaultImage,
          certificationImage,
          detailImages
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <Form
        ...
        layout='vertical'
        initialValues={{ customerId: username }}>
        <Flex gap='large'>
            ...
            <Form.Item label='상세 이미지'>
              <Upload
                ...
                <Button icon={<UploadOutlined />}>
                  식품상세이미지업로드({detailImages.length}/5)
                </Button>
              </Upload>
            </Form.Item>
          ...
          <Flex vertical gap='middle' style={{ width: "70%" }}>
            ...
            <Flex gap='middle'>
              ...
              <Form.Item
                name='origin'
                label='원산지'
                rules={[{ required: true, message: "원산지를 입력하세요" }]}
                style={{ width: "30%" }}>
                <Input />
              </Form.Item>
            </Flex>
            ...
            <Form.Item
              name='description'
              label='상품 설명'
              rules={[{ required: true, message: "상품설명을 입력하세요" }]}>
              <TextArea rows={4} />
            </Form.Item>
            ...
            {selectedFoodType === "친환경식품" && (
              <Flex gap='middle'>
                <Form.Item
                  ...
                  label='인증서명'
                  rules={[{ required: true, message: "인증서명을 입력하세요" }]}
                  style={{ width: "30%" }}>
                  <Input />
                </Form.Item>
                <Form.Item
